...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#">Customer V1</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Customer V1</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<script type="text/javascript">
  ...
  $("#prov").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        $('#kel').html('');
        $('#kode_p').html('');
        $('#kota').append('<option value="">Kota mana</option>');
        $('#kec').append('<option value="">Kec</option>');
        $('#kel').append('<option value="">Kelurahan</option>');
        $('#kode_p').html('<option value="">KodePos</option>');
  ...
  $("#kec").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        $('#kode_p').html('');
        $('#kel').append('<option value="">Kelurahan</option>');
        $('#kode_p').html('<option selected value="">KodePos</option>');
  ...
  $("#kel").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
          $('#kode_p').html('');
          $('#kode_p').append('<option selected value="'+data[0].id_kelurahan+'">'+data[0].kodepos+'</option>');
